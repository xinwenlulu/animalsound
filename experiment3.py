...
from models import createAttentionModel, evaluate_on_test
...
for i in range(num_trials):
    ...
    model, history = createAttentionModel(learning_rate, f1_m, precision_m, recall_m, path_list_dict,
                                          partition_size_dict, epochs=epochs, patience=patience,
                                        filters=[32, 64, 128], activations=['relu', 'relu'],
